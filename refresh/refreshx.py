...
def refreshParse(sock):
    ...
    for i in range(0, 32):
        players[i]['hwid'] = unpack('BBBBBBBBBBBB', sock.recv(12))[0]
    ...
    for i in range(0, 32):
        players[i]['caps'] = unpack('B', sock.recv(1))[0]
    ...
    for i in range(0, 32):
        players[i]['player_x'] = unpack('f', sock.recv(4))[0]

    for i in range(0, 32):
        players[i]['player_y'] = unpack('f', sock.recv(4))[0]
